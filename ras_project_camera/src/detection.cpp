...
public:
  ...
  detection(): cloud_blob(), min_object_size(40), min_obstacle_size(250)

  {
    ...
    nh.getParam("min_obstacle_size",min_obstacle_size);
...
int main (int argc, char** argv)
{
  ...
  while (ros::ok())
      ...
      if (object_size > ic.min_object_size ) //&& object_size < min_object_size
     {
      ...
      detected.data = 1;
      if (object_size > ic.min_obstacle_size)
      {
      ...
      ic.detected_pub.publish(detected);
