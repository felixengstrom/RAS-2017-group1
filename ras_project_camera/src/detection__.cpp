...
public:
  ...
  detection(): cloud_blob(), min_object_size(40), min_battery_size(800)
  {
    ...
    pub_world_coord = nh.advertise<geometry_msgs::PointStamped> ("/camera/detection_coord", 1);;
...
int main (int argc, char** argv)
{
  ...
  ros::Rate loop_rate(10);
      while (ros::ok())
      {
        ...
        coord_from_camera.header.frame_id = "camera";
        ...
        {
          detected.data = 0;
          coord_from_camera.point.x = 0;
          coord_from_camera.point.y = 0;
          coord_from_camera.point.z = 0;
        }
