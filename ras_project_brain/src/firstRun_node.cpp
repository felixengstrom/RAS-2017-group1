        ...
        else
        {
            ...
            switch(current_state_exit)
            {
                ...
                case DONE:
                    ...
                    save_data = 1;
                    msg_objectFileSave_bool.data = save_data;
...
private:
    ...
    bool uarm_smTrigger, sm_complete_ack, engage_suction, pickup_success, stop_robot;
    bool save_data;
    ...
    std_msgs::Bool msg_objectFileSave_bool,msg_stopRobot_bool;
